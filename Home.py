...
Explore:
- 🧠 **[Chatbot](./Chatbot.py)** — Ask questions about race results, athlete stats, and predictions.
- ℹ️ **[About Trilytx](./About_Trilytx.py)** — Learn what powers this project and how it works.
